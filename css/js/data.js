window.AI_BAYAN_DATA = {
  ...
  irregularVerbs: [
    ["be","was/were","been","быть"],["become","became","become","становиться"],
    ["begin","began","begun","начинать"],["break","broke","broken","ломать"],
    ["bring","brought","brought","приносить"],["build","built","built","строить"],
    ["buy","bought","bought","покупать"],["catch","caught","caught","ловить"],
    ["choose","chose","chosen","выбирать"],["come","came","come","приходить"],
    ["cost","cost","cost","стоить"],["cut","cut","cut","резать"],
    ["do","did","done","делать"],["draw","drew","drawn","рисовать"],
    ["drink","drank","drunk","пить"],["drive","drove","driven","водить"],
    ["eat","ate","eaten","есть"],["fall","fell","fallen","падать"],
    ["feel","felt","felt","чувствовать"],["find","found","found","находить"],
    ["fly","flew","flown","летать"],["forget","forgot","forgotten","забывать"],
    ["get","got","got/gotten","получать"],["give","gave","given","давать"],
    ["go","went","gone","идти"],["grow","grew","grown","расти"],
    ["have","had","had","иметь"],["hear","heard","heard","слышать"],
    ["keep","kept","kept","держать"],["know","knew","known","знать"],
    ["learn","learnt/learned","learnt/learned","учить"],["leave","left","left","покидать"],
    ["lose","lost","lost","терять"],["make","made","made","делать"],
    ["meet","met","met","встречать"],["pay","paid","paid","платить"],
    ["put","put","put","класть"],["read","read","read","читать"],
    ["ride","rode","ridden","ездить верхом"],["run","ran","run","бежать"],
    ["say","said","said","сказать"],["see","saw","seen","видеть"],
    ["sell","sold","sold","продавать"],["send","sent","sent","отправлять"],
    ["sing","sang","sung","петь"],["sit","sat","sat","сидеть"],
    ["sleep","slept","slept","спать"],["speak","spoke","spoken","говорить"],
    ["spend","spent","spent","тратить"],["stand","stood","stood","стоять"],
    ["swim","swam","swum","плавать"],["take","took","taken","брать"],
    ["teach","taught","taught","учить"],["tell","told","told","рассказывать"],
    ["think","thought","thought","думать"],["understand","understood","understood","понимать"],
    ["wear","wore","worn","носить"],["win","won","won","выигрывать"],
